...
const Hero = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      title: "Timeless",
      subtitle: "Elegance",
      description: "Discover the brilliance of our exclusive jewelry collection. Handcrafted perfection for those who appreciate the finer things.",
      ctaLink: "/shop?category=jewelry",
      ctaText: "Shop Jewelry",
      bgImage: "https://images.unsplash.com/photo-1641284356881-0f9a340f8a70?fm=jpg&q=80&w=1920",
      accentFrom: "#d4af37",
      accentTo: "#f2d0a9",
    },
    {
    ...
    },
    {
      ...
      title: "Essence",
      subtitle: "Of Luxury",
      description: "Immerse yourself in our curated selection of premium fragrances. Scents that captivate and linger.",
      ctaLink: "/shop?category=fragrances",
      ctaText: "Shop Fragrances",
      bgImage: "https://images.unsplash.com/photo-1737424065243-117191bc1345?fm=jpg&q=80&w=1920",
      accentFrom: "#c0c0c0",
      accentTo: "#e5e4e2",
    },
    {
      ...
      title: "Master",
      subtitle: "Of Time",
      description: "Precision engineering meets exquisite design. Explore our collection of world-class timepieces.",
      ctaLink: "/shop?category=mens-watches",
      ctaText: "Shop Watches",
      bgImage: "https://images.unsplash.com/photo-1607996108811-94137abf5ccf?fm=jpg&q=80&w=1920",
      accentFrom: "#ffd700",
      accentTo: "#dba514",
    },
  ];
